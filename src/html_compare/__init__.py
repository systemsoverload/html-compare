...
# Ported from django test utilites here - https://github.com/django/django/blob/main/django/test/html.py
...
def assert_and_parse_html(html, user_msg, msg):
    try:
        ...
        standardMsg = "%s\n%s" % (msg, e)
        raise Exception(user_msg, standardMsg)


def html_equal(html1, html2, msg=None):
    """
    Assert that two HTML snippets are semantically the same.
    Whitespace in most cases is ignored, and attribute ordering is not
    significant. The arguments must be valid HTML.
    """
    dom1 = assert_and_parse_html(html1, msg, "First argument is not valid HTML:")
    dom2 = assert_and_parse_html(html2, msg, "Second argument is not valid HTML:")
    ...
    if dom1 != dom2:
        ...
        raise Exception(standardMsg, diff)
    return True
